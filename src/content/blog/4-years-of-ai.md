...
Early warning [signs](https://www.dailycal.org/news/campus/academics/failing-grades-soar-as-professors-see-greater-ai-usage-dwindling-math-skills-in-uc-berkeley/article_16fad0bf-02cb-4b8c-8d88-888ffd9f8608.html) are already appearing at top universities, and that is likely the tip of the iceberg that is to come around the world.
...
1. AI proficiency should be an expectation, treat it as a first-class skill and learning outcome  
2. There is a wrong way to use AI, be opinionated about this invariant in different settings and skill levels  
3. Bring the agent to class, that’s how we check the homework. The process is just as important as the final output. 
